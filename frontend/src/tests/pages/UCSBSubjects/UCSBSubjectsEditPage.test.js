...
describe("UCSBSubjectsEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(subjectCodeField).toHaveValue("MATH");
            expect(subjectTranslationField).toHaveValue("Math");
            expect(deptCodeField).toHaveValue("MATH");
            expect(collegeCodeField).toHaveValue("L&S");
            expect(relatedDeptCodeField).toHaveValue("null");
